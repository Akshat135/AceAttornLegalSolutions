...
const HeroSection = () => {
  ...
  useEffect(() => {
   ...
   useEffect(() => {
    ...
    script.src = 'https://wdg.fouita.com/widgets/0x2b714b.js'; // Google Reviews widget
    script.async = true;
  ...
  return (
    <section className="hero-section" id="home">
              ...
              <div className={`hero-content-wrapper ${isVisible ? 'visible' : ''}`}>
               ...
               {/* <div className="hero-contact-info">
                  ...
                  <div className="contact-item">
                    ...
                    <span>info@aceattornlegalsolutions.com</span>
                  </div>
                  <div className="contact-item">
      ...
      {/* Stats Section   bwlow hero and above google review */}
      ...
      <div className="google-reviews-section">
        ...
        <div data-key="Masonry Google Reviews" className="ft" id="ft5zipxqv" style={{ minHeight: '500px' }}></div>
      </div>
    </section>
  );
};
