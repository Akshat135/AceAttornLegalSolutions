...
const Trademark = () => {
  const services = [
    
    {
      ...
      description: "File and register your creative works to protect your intellectual property.",
    ...
    },
    {
      ...
      description: "Enforce your copyright rights and handle infringement litigation.",
      features: ["Opposition proceedings", "Infringement litigation", "Legal representation", "Settlement negotiation"]
    },
    {
      id: 3,
      icon: <FaEye />,
      title: "Licensing and Transfer",
      description: "Assist with licensing agreements and the transfer of copyright ownership.",
