  ...
  const services = [
    {
      ...
      description: "Analyze contracts to identify potential risks and ensure compliance.",
    ...
    },
    {
      ...
      description: "Draft and review legal contracts to ensure they meet all regulatory requirements.",
    ...
    },
    {
      ...
      description: "Manage vendor contracts to ensure compliance and minimize risks.",
      features: ["Opposition proceedings", "Infringement litigation", "Legal representation", "Settlement negotiation"]
    },
    {
      id: 4,
      icon: <FaEye />,
      title: "Amendments and Risk Management",
      description: "Handle contract amendments and manage associated risks.",
