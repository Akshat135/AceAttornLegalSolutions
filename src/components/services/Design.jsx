  ...
  const services = [
    {
      id: 1,
      icon: <FaSearch />,
      title: "Design Search and Filing",
      description: "Conduct searches and file design applications.",
    ...
    },
    {
      ...
      description: "Register your designs to protect their unique appearance.",
    ...
    },
    {
      ...
      description: "Enforce your design rights against unauthorized use.",
