  ...
  const services = [
    {
      ...
      description: "Evaluate legal cases and provide expert advice.",
    ...
    },
    {
      ...
      icon: <FaFileAlt />,
      title: "Legal Notices",
      description: "Draft and send legal notices for various purposes.",
    ...
    },
    {
      ...
      description: "Negotiate settlements to resolve disputes amicably.",
